package top.weidaboy.educenter.service.impl;
...
import top.weidaboy.educenter.mapper.UcenterMemberMapper;
import top.weidaboy.educenter.service.UcenterMemberService;
import top.weidaboy.educenter.utils.MD5;
...
public class UcenterMemberServiceImpl extends ServiceImpl<UcenterMemberMapper, UcenterMember> implements UcenterMemberService {
    ...
    public String login(UcenterMember member) {
        ...
        //加密方式 MD5  MD5.encrypt(password) --》获得加密后的密码
        ...
        //登录成功
        //生成token字符串，使用jwt工具类  token主体内容包括id 姓名
